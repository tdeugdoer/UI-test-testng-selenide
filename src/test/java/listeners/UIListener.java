...
public class UIListener implements ITestListener {
    ...
    public void onStart(ITestContext context) {
        Configuration.baseUrl = System.getProperty("base.url", "https://pizzeria.skillbox.cc/");
        Configuration.browser = System.getProperty("browser", Browsers.EDGE);
        Configuration.browserSize = "1920x1080";
        Configuration.headless = Boolean.parseBoolean(System.getProperty("headless", Boolean.FALSE.toString()));
